  ...
  return (
    <section className='flex h-[550px] py-0 px-[60px] bg-[#000] text-[#fff]'>
      <div className='w-[50%] align_center justify-center flex-col text-center'>
        ...
        <Link className='py-[16px] px-[32px] uppercase tracking-[1.5px] font-[700] border-[2px] border-solid border-[#fff] bg-[#fff] text-[#000] hover:bg-transparent hover:text-[#fff] transition-all duration-300 ease-in-out rounded-[32px]' to={link}>Buy Now</Link>
      </div>
